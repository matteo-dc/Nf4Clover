...
enum TK_glb_t{FEOF_GLB_TK,VALUE_GLB_TK,NCONFS_TK,NJACKS_TK,ACT_TK,PATH_TK,NBETA_TK,BETA_TK,BETA_LAB_TK,VOLUME_LAB_TK,  \
              NM_SEA_TK,SEAMASSES_LAB_TK,SEAMASSES_TK,NR_TK,NTYPES_TK,NHITS_TK,USE_SIGMA_TK,USE_EFF_MASS_TK,SCHEME_TK, \
