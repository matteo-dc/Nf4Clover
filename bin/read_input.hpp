...
enum TK_glb_t{FEOF_GLB_TK,VALUE_GLB_TK,NCONFS_TK,NJACKS_TK,ACT_TK,PATH_TK,NBETA_TK,BETA_TK,BETA_LAB_TK,VOLUME_LAB_TK,NTHETA_TK, \
              THETA_LAB_TK,NM_SEA_TK,SEAMASSES_LAB_TK,SEAMASSES_TK,NR_TK,NTYPES_TK,NHITS_TK,USE_SIGMA_TK,USE_EFF_MASS_TK,SCHEME_TK, \
              NF_TK,NC_TK,AINV_TK,CSW_TK,LAMBDAQCD_TK,BC_TK,P2MIN_TK,P2MAX_TK,THRESH_TK,COMPUTE_MESLEP_TK,OUT_HADR_TK,OUT_LEP_TK,ONLY_BASIC_TK, \
              COMPUTE_MPCAC_TK,ANALYSIS_TK,CLOVER_TK,P2REF_TK,LOAD_AVE_TK,LOAD_CHIR_TK,SUFFIX_TK,QCDONTHERIGHT_TK,SUB_BOOSTED_TK,SUB_PTILDE_TK, \
              SUBTRACTION_TK, CHIR_ANSATZ_VAL_TK,CHIR_ANSATZ_SEA_TK,STEPFUNC_MIN_TK,STEPFUNC_MAX_TK,P2MAX_M3_M4_TK,P2MIN_M3_M4_TK,LOAD_LABEL_TK};
